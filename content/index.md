...
Het volgende plaatje illustreert het evolueren van zo'n netwerk of knowledge graph:

![[knowledge_graph_growth Bregman.jpg]]
(uit Bergman - Knowledge Representation: A Practionary).
...
Desondanks is kwalitatief hoogwaardige informatie relatief gemakkelijk te verkrijgen (voor wie bereid is, daar enige moeite voor te doen). Toch tiert de desinformatie welig, ook als het gaat om muziek-inhoudelijke zaken. 
...
(https://h5p.skole.nl).  Het bouwt voort op de gedachten achter de invulling van Contextuele Studies. Dat draaide (kort gezegd) om onderzoekend bezig zijn met muziek geplaatst in haar context. Dit alles is uiteraard voortdurend "under construction". Alle dingen die ik maak en neerzet op https://h5p.skole.nl  zijn op te nemen in een LMS zoals Moodle of BrightSpace.
...
- Erickson, H. L., Lanning, L. A., & French, R. (2017). *Concept-based curriculum and instruction for the thinking classroom* (Second edition). Corwin.
