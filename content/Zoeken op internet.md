...
1. Formuleer een of meer (goede) vragen
2. Kies **niet** meteen de weg van de minste weerstand: gemakkelijk, snel, oppervlakkig, niet-kritisch... Het is een garantie voor informatie van meestal bedenkelijk of zelfs slechte kwaliteit (nl.wikipedia...)
3. Begin bij een (goede) **encyclopedie** of ander **naslagwerk** en bestudeer **kernartikelen**
4. Deze kernartikelen bevatten altijd een **bronvermelding** met relevante verwijzingen
5. Gebruik niet alleen maar "gewoon" Google maar ook **scholar.google.com** en alle andere beschikbare en relevante **databases** en **portals**
6. Maak gebruik van de **Library-guides** op hanze.nl
7. Gebruik **operators** bij het zoeken (AND, OR, NOT, NEAR, ... en text strings tussen " ")
