Wordt ook wel Web 3.0 genoemd, dat als doel heeft internet data machine readable te maken.
Dit gaat (uiteraard) niet zonder bepaalde (W3C) standaarden, zoals:
- Resource Descrition Framework (RDF)
- Web Ontology Language (OWL2)
- Extensible Markup Language (XML), waarbinnen ook weer een music XML variant bestaat
